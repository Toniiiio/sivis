...
scraper <- list(
	...
	urlGen = function(nr){
		maxItems <- 100
		paste0("https://careers.intuitive.com/api/jobs?page=2&internal=false&userId=c584a5e0-ba11-4d19-b2e2-25622b9e90e7&sessionId=773f7446-1621-4a38-be64-d164d00924d6&deviceId=2247746357&domain=intuitivesurgical.jibeapply.com")
	},
	base = "jobs",
	baseFollow = "data",
	targetKeys = list("title")
)
...
ui <- fluidPage(
	...
	selected = "title", choiceNames = choiceNames)
)
