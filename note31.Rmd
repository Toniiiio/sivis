...
scraper <- list(
	...
	urlGen = function(nr){
		maxItems <- 100
		paste0("https://www.warnermediagroup.com/careers/job-search?keyword=&op=Submit")
	},
	base = NULL,
	baseFollow = NULL,
	targetKeys = list("JobPostCode", "ContestNumber", "JobTitle")
)
...
ui <- fluidPage(
	...
	selected = "", choiceNames = choiceNames)
)
