...
scraper <- list(
	...
	urlGen = function(nr){
		maxItems <- 100
		paste0("https://www.pmi.com/api/JobFilterWidgetApi/SearchContent?title=&contract=&locations=&department=&page=0&itemsPerPage=6")
	},
	base = "JobPosts",
	baseFollow = NULL,
	targetKeys = list("JobTitle")
)
...
ui <- fluidPage(
	...
	selected = "JobTitle", choiceNames = choiceNames)
)
