...
scraper <- list(
	...
	urlGen = function(nr){
		maxItems <- 100
		paste0("https://www.biogen.com/bin/dxp/career/search?searchKey=&category=null&location=Switzerland-Zug%20Headquarters&region=null&joblevel=null&jobtype=null")
	},
	base = "content",
	baseFollow = NULL,
	targetKeys = list("name")
)
...
ui <- fluidPage(
	...
	selected = "name", choiceNames = choiceNames)
)
